...
public class TaiKhoanPDF {
	...
	Document document = new Document();
		...
		try
		{
                ...
                List<AccountDTO> listAccounts = accountDAO.listAccounts();
                List<StaffDTO> listStaffs = staffDAO.listStaffs();
              
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(filePath));
		document.open();
                
		PdfPTable table = new PdfPTable(4);            
                Paragraph LabelHoaDon = new Paragraph("Tài Khoản",font);
		...
		PdfPCell cell2 = new PdfPCell(new Paragraph("Tên Tài Khoản",font));
		cell2.setBorderColor(BaseColor.BLACK);
		cell2.setPaddingLeft(10);
		cell2.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell2.setVerticalAlignment(Element.ALIGN_MIDDLE);

		PdfPCell cell3 = new PdfPCell(new Paragraph("Mật Khẩu",font));
		cell3.setBorderColor(BaseColor.BLACK);
		cell3.setPaddingLeft(10);
		cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell3.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        
                PdfPCell cell4 = new PdfPCell(new Paragraph("Chức Danh",font));
		...
		table.addCell(cell3);
                ...
                for (AccountDTO account : listAccounts) 
                    {
                    String IDString = String.valueOf(account.getID());
                    ...
                    PdfPCell celladd2 = new PdfPCell(new Paragraph(account.getUserName(),font));
                    ...
                    PdfPCell celladd3 = new PdfPCell(new Paragraph(account.getPassword(),font));
                    ...
                    String LevelString = String.valueOf(account.getLevel());
                    PdfPCell celladd4 = new PdfPCell(new Paragraph(LevelString,font));
		...
		PdfPCell cell6 = new PdfPCell(new Paragraph("ID",font));
		cell6.setBorderColor(BaseColor.BLACK);
		cell6.setPaddingLeft(10);
		cell6.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell6.setVerticalAlignment(Element.ALIGN_MIDDLE);

		PdfPCell cell7 = new PdfPCell(new Paragraph("Họ",font));
		cell7.setBorderColor(BaseColor.BLACK);
		cell7.setPaddingLeft(10);
		cell7.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell7.setVerticalAlignment(Element.ALIGN_MIDDLE);

		PdfPCell cell8 = new PdfPCell(new Paragraph("Tên",font));
		cell8.setBorderColor(BaseColor.BLACK);
		cell8.setPaddingLeft(10);
		cell8.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell8.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        
                PdfPCell cell9 = new PdfPCell(new Paragraph("Ngày Sinh",font));
		cell9.setBorderColor(BaseColor.BLACK);
		cell9.setPaddingLeft(10);
		cell9.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell9.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        
                PdfPCell cell10 = new PdfPCell(new Paragraph("Email",font));
		cell10.setBorderColor(BaseColor.BLACK);
		cell10.setPaddingLeft(10);
		cell10.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell10.setVerticalAlignment(Element.ALIGN_MIDDLE);
                
                PdfPCell cell11 = new PdfPCell(new Paragraph("Lương",font));
		...
		table2.addCell(cell8);
                ...
                for (StaffDTO staff : listStaffs) 
                    {
                    PdfPCell celladd1 = new PdfPCell(new Paragraph(staff.getCodeStaff(),font));
                    celladd1.setBorderColor(BaseColor.BLACK);
                    celladd1.setPaddingLeft(10);
                    celladd1.setHorizontalAlignment(Element.ALIGN_CENTER);
                    celladd1.setVerticalAlignment(Element.ALIGN_MIDDLE);

                    PdfPCell celladd2 = new PdfPCell(new Paragraph(staff.getLastName(),font));
                    celladd2.setBorderColor(BaseColor.BLACK);
                    celladd2.setPaddingLeft(10);
                    celladd2.setHorizontalAlignment(Element.ALIGN_CENTER);
                    celladd2.setVerticalAlignment(Element.ALIGN_MIDDLE);

                    PdfPCell celladd3 = new PdfPCell(new Paragraph(staff.getFirstName(),font));
                    celladd3.setBorderColor(BaseColor.BLACK);
                    celladd3.setPaddingLeft(10);
                    celladd3.setHorizontalAlignment(Element.ALIGN_CENTER);
                    celladd3.setVerticalAlignment(Element.ALIGN_MIDDLE);

                    String NumberString = String.valueOf(staff.getDateOfBirth());
                    ...
                    String SaleString = String.valueOf(staff.getEmail());
                    ...
                    String LuongString = String.valueOf(staff.getSalary());
                    PdfPCell celladd6 = new PdfPCell(new Paragraph(LuongString,font));
