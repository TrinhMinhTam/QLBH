...
public class NCCPDF {
	...
	Document document = new Document();
            ...
            try
		{
                ...
                List<SupplierDTO> listSuppliers = supplierDAO.listSuppliers();
              
                PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(filePath));
		document.open();
                
		PdfPTable table = new PdfPTable(4);            
                Paragraph LabelHoaDon = new Paragraph("Nhà Cung Cấp",font);
		...
		PdfPCell cell1 = new PdfPCell(new Paragraph("Mã NCC", font));
		cell1.setBorderColor(BaseColor.BLACK);
		cell1.setPaddingLeft(10);
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell1.setVerticalAlignment(Element.ALIGN_MIDDLE);

		PdfPCell cell2 = new PdfPCell(new Paragraph("Tên NCC", font));
		cell2.setBorderColor(BaseColor.BLACK);
		cell2.setPaddingLeft(10);
		cell2.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell2.setVerticalAlignment(Element.ALIGN_MIDDLE);

		PdfPCell cell3 = new PdfPCell(new Paragraph("Địa Chỉ", font));
		cell3.setBorderColor(BaseColor.BLACK);
		cell3.setPaddingLeft(10);
		cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell3.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        
                PdfPCell cell4 = new PdfPCell(new Paragraph("SĐT", font));
		...
		table.addCell(cell3);
                ...
                for (SupplierDTO supplier : listSuppliers) 
                    {
                    PdfPCell celladd1 = new PdfPCell(new Paragraph(supplier.getCodeSupplier(), font));
                    ...
                    PdfPCell celladd2 = new PdfPCell(new Paragraph(supplier.getNameSupplier(), font));
                    ...
                    PdfPCell celladd3 = new PdfPCell(new Paragraph(supplier.getAddressSupplier(), font));
                    ...
                    PdfPCell celladd4 = new PdfPCell(new Paragraph(supplier.getPhonenumberSupplier(), font));
